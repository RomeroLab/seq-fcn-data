...
This is Mary Farrow's library.  I'm not sure why it never got published.

Devin also worked on Cel5.  There may be more data here: Exploring the Mechanism Responsible for Cellulase Thermostability by Structure-Guided Recombination"""


import pickle

# load block alignment for eight block library
block_alignment, column_names = read_alignment('cel5_block_alignment.aln')

# load contacts 
contacts = pickle.load(open('cel5_contacts.pkl','rb'))

# load binary function data 
names,function_data = read_data('cel5_function.data')
