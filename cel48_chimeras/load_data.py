...
This was Matt Smith's library.  The data here is some of his early results.

There is significantly more data (including thermostability) here: A diverse set of family 48 bacterial glycoside hydrolase cellulases created by structure-guided recombination"""


import pickle

# load block alignment for eight block library
block_alignment, column_names = read_alignment('cel48_block_alignment.aln')

# load contacts 
contacts = pickle.load(open('cel48_contacts.pkl','rb'))

# load binary function data 
names,function_data = read_data('cel48_function.data')
